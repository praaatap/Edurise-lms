    ...
    () => (
      <View className="px-1">
        ...
        <View className="mt-6 mb-4">
          <Text className="text-lg font-bold text-text dark:text-dark-text mb-3 px-1">
            Tech Tracks
          </Text>
          <ScrollView
            horizontal
      ...
      >
        <BottomSheetView className="px-6 py-4 pb-12">
          <View className="flex-row justify-between items-center mb-6">
            <Text className="text-2xl font-extrabold text-text dark:text-dark-text">
              Filters
            </Text>
          ...
          <Text className="text-base font-bold text-text dark:text-dark-text mb-3">
            Skill Level
          </Text>
                ...
                style={{
                  backgroundColor:
                    selectedLevel === level
                      ...
                      : C.surfaceElevated,
                  borderColor:
                    selectedLevel === level ? Colors.primary : C.border,
                }}
                className="px-4 py-2.5 rounded-2xl border"
              >
                <Text
                  style={{ color: selectedLevel === level ? 'white' : C.text }}
                  className="font-bold"
                >
                  {level}
                </Text>
                ...
                style={{
                  backgroundColor:
                    selectedPrice === range
                      ...
                      : C.surfaceElevated,
                  borderColor:
                    selectedPrice === range ? Colors.primary : C.border,
                }}
                className="px-4 py-2.5 rounded-2xl border"
              >
                <Text
                  style={{ color: selectedPrice === range ? 'white' : C.text }}
                  className="font-bold"
                >
                  {range}
                </Text>
          ...
          <View className="flex-row flex-wrap gap-2 mb-8">
            {[
              ...
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    sortBy === option ? Colors.primary : C.surfaceElevated,
                  borderColor: sortBy === option ? Colors.primary : C.border,
                }}
                className="px-4 py-2.5 rounded-2xl border"
              >
                <Text
                  style={{ color: sortBy === option ? 'white' : C.text }}
                  className="font-bold"
                >
                  {option}
                </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              trackUserAction('filters_applied', {
                level: selectedLevel,
                price: selectedPrice,
                sortBy,
              });
              clarityService.logEvent('course_filter_applied', {
                level: selectedLevel,
                price: selectedPrice,
              });
