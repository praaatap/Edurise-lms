      ...
      >
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 24 }}>
          <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 12 }}>
            <View>
              <Text style={{ color: C.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.4 }}>Settings</Text>
              <Text style={{ color: C.text, fontSize: 18, fontWeight: '800', marginTop: 4 }}>Control your experience</Text>
            </View>
            <View style={{ backgroundColor: isDark ? 'rgba(72,199,142,0.12)' : 'rgba(72,199,142,0.1)', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999 }}>
              <Text style={{ color: Colors.primary, fontSize: 11, fontWeight: '800', letterSpacing: 0.8 }}>Personal</Text>
            </View>
          </View>

          <View style={{ gap: 14 }}>
            <View style={{ backgroundColor: isDark ? Colors.dark.surface : '#fff', borderRadius: 24, borderWidth: 1, borderColor: isDark ? Colors.dark.border : '#e2e8f0', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: isDark ? 0.18 : 0.05, shadowRadius: 14, elevation: 2 }}>
              <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
                <Text style={{ color: C.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.2 }}>Appearance</Text>
              </View>

              <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }}>
                <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(99,102,241,0.15)' : '#ede9fe', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                  <Ionicons name="moon" size={18} color="#6366f1" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Dark Mode</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Reduce glare with a darker interface</Text>
                </View>
              ...
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }} activeOpacity={0.7} onPress={() => { router.push('/profile/app-icon'); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); }}>
                <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(34,197,94,0.15)' : '#dcfce7', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                  <Ionicons name="apps" size={18} color="#22c55e" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>App Icon</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Choose a cleaner badge for your home screen</Text>
                </View>
            ...
            <View style={{ backgroundColor: isDark ? Colors.dark.surface : '#fff', borderRadius: 24, borderWidth: 1, borderColor: isDark ? Colors.dark.border : '#e2e8f0', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: isDark ? 0.18 : 0.05, shadowRadius: 14, elevation: 2 }}>
              <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
                <Text style={{ color: C.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.2 }}>Notifications & Security</Text>
              </View>
              ...
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }} activeOpacity={0.7} onPress={() => { router.push('/profile/notifications'); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); }}>
                <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(249,115,22,0.15)' : '#fff7ed', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                  <Ionicons name="notifications" size={18} color="#f97316" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Notifications</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Manage reminders and alerts</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color={C.textMuted} />
              </TouchableOpacity>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Biometric Unlock</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Use Face ID or fingerprint to sign in</Text>
                </View>
              ...
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }} activeOpacity={0.7}>
                <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(239,68,68,0.12)' : '#fee2e2', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                  <Ionicons name="shield-checkmark" size={18} color="#ef4444" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Privacy & Security</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Review account privacy settings</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color={C.textMuted} />
              </TouchableOpacity>
            </View>
            ...
            <View style={{ backgroundColor: isDark ? Colors.dark.surface : '#fff', borderRadius: 24, borderWidth: 1, borderColor: isDark ? Colors.dark.border : '#e2e8f0', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: isDark ? 0.18 : 0.05, shadowRadius: 14, elevation: 2 }}>
              <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
                <Text style={{ color: C.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.2 }}>Developer</Text>
              </View>
              ...
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 }} activeOpacity={0.7} onPress={() => { router.push('/profile/send-notification' as any); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); }}>
                <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(99,102,241,0.15)' : '#eef2ff', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                  <Ionicons name="send" size={18} color="#6366f1" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Send Notification</Text>
                  <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Trigger test notifications from inside the app</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color={C.textMuted} />
              </TouchableOpacity>
            </View>
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 16 }}>
          <View style={{ backgroundColor: isDark ? Colors.dark.surface : '#fff', borderRadius: 24, borderWidth: 1, borderColor: isDark ? Colors.dark.border : '#e2e8f0', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: isDark ? 0.18 : 0.05, shadowRadius: 14, elevation: 2 }}>
            <View style={{ paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 }}>
              <Text style={{ color: C.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.2 }}>Developer Tools</Text>
            </View>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Try Sentry Error</Text>
                <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Send a test error to verify monitoring</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={C.textMuted} />
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <View style={{ width: 42, height: 42, borderRadius: 14, backgroundColor: isDark ? 'rgba(245,158,11,0.15)' : '#fffbeb', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                <Ionicons name="flask" size={18} color="#F59E0B" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ color: C.text, fontSize: 15, fontWeight: '700' }}>Event Testing Dashboard</Text>
                <Text style={{ color: C.textMuted, fontSize: 12, marginTop: 2 }}>Inspect analytics, events, and debug flows</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={C.textMuted} />
            </TouchableOpacity>
          </View>
        ...
        <View style={{ paddingHorizontal: 20 }}>
          <View style={{ backgroundColor: isDark ? Colors.dark.surface : '#fff', borderRadius: 24, borderWidth: 1, borderColor: isDark ? 'rgba(239,68,68,0.18)' : '#fecaca', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: isDark ? 0.18 : 0.05, shadowRadius: 14, elevation: 2 }}>
            <TouchableOpacity
              style={{
            ...
            >
              ...
              <Text style={{ color: '#ef4444', fontSize: 15, fontWeight: '800' }}>Sign Out</Text>
            </TouchableOpacity>

            <View style={{ paddingHorizontal: 16, paddingVertical: 14, alignItems: 'center' }}>
              <Text style={{ color: C.textMuted, fontSize: 11, textAlign: 'center', opacity: 0.65, fontWeight: '600' }}>
                App Version 2.1.0
              </Text>
            </View>
          </View>
