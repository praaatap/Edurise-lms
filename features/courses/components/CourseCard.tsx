...
export const CourseCard = React.memo(
  ({ course, onPress, onToggleBookmark, onLongPress, isBookmarked, isEnrolled, isCompleted, compact = false }: CourseCardProps) => {
    ...
    const imageHeight = compact ? 156 : 192;
    const outerPadding = compact ? 16 : 20;
    const titleClass = compact
      ? 'mb-2 text-[16px] font-bold leading-6 text-text dark:text-dark-text'
      : 'mb-2 text-[18px] font-bold leading-7 text-text dark:text-dark-text';
      ...
      <AnimatedTouchableOpacity
        ...
        style={[
          animatedStyle,
          {
            ...
            shadowRadius: compact ? 12 : 14,
            elevation: compact ? 3 : 4,
          },
        ]}
        onPress={() => onPress(course)}
        onPressIn={handlePressIn}
        onPressOut={handlePressOut}
        onLongPress={onLongPress ? () => onLongPress(course) : undefined}
        activeOpacity={0.92}
      >
        {/* Thumbnail */}
        ...
        {/* Card body */}
        <View style={{ padding: outerPadding }}>
          <Badge
            ...
            <View className="flex-row items-center">
              <View className="relative">
                <Image
                  ...
                  style={{ width: compact ? 34 : 40, height: compact ? 34 : 40, borderRadius: 999 }}
                  cachePolicy="memory-disk"
                />
